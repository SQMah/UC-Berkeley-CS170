...
\providecommand{\routine}[1]{{\ttfamily #1()\/}}%
...
\providecommand{\nonetwork}{If your computer isn't connected to the
  ...
  License Details page for your license (which can be found by visiting
  \htmladdnormallink{Current Gurobi Licenses}{https://www.gurobi.com/downloads/licenses}
  and clicking on the appropriate {\em License ID\/}).}%
...
\stepcounter{section}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1976}%
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap2091}%
...
\scalebox{1.0}{\fbox{\includegraphics[width=6.2in]{graphics/anaconda_download}}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap6521}%
\scalebox{1.0}{\includegraphics[width=5.5in]{graphics/spyder_linux2}}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap6531}%
